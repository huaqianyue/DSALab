...
interface FileOpenDirectoryDialogOptions {
  title?: string;
  defaultPath?: string;
}
type FileOpenDirectoryDialogResult = {
  success: true;
  canceled: boolean;
  filePaths: string[];
} | {
...
export type IpcCommands = {
  ...
  'file/openDirectoryDialog': (options: FileOpenDirectoryDialogOptions) => FileOpenDirectoryDialogResult;
